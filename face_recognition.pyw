...
class face_recognition:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="Face Recognition",font=("times new romen",25,"bold"),bg="darkblue",fg='white')
        ...
        lbl=Label(title_lbl,font=('digital-7 mono',30,'bold'),bg="darkblue",fg='white')
        lbl.place(x=70,y=0)
        time()
        ...
        rec=Button(bg_img,text="Face Recognition",command=self.face_recog,font=("times new romen",20,"bold"),bg="white",fg="blue")
...
#**Atttendance
    ...
    def face_recog(self):
        ...
        def recogize(img,clf,faceClasscade):
            coord=drow_boundray(img,faceClasscade,1.1,10,(255,25,255),"Face",clf)
            return img


        faceClasscade = cv2.CascadeClassifier(os.path.join(cv2.data.haarcascades, "haarcascade_frontalface_default.xml") )
